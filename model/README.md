...
1. **[VERIFIED FACT]** Заменить `PIN_BEFORE_TRAINING` на immutable Hugging Face
   commit revision.
2. **[VERIFIED FACT]** Создать manifest всех обязательных файлов, размеров и
   SHA-256.
3. **[VERIFIED FACT]** Архивировать и хешировать upstream Apache-2.0 license и
   notices.
